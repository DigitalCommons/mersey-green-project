  ...
  vocabularies: [
    {
      ...
      type: 'hostSparql',
      label: 'essglobal',
      endpoint: 'http://data.digitalcommons.coop:8890/sparql',
	    defaultGraphUri: 'https://lod.coop/sea-lod/mersey-green',
      uris: {
        'https://lod.coop/essglobal/V2a/standard/activities-modified/': 'am',
        'https://lod.coop/essglobal/V2a/standard/organisational-structure/': 'os',
      },
    },
  ],
  dataSources: [
